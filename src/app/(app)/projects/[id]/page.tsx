  ...
  return (
    <div className="flex-1 min-h-0">
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="relative aspect-[3/1] bg-muted rounded overflow-hidden mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="shrink-0">
            <div className="relative w-32 h-32 rounded overflow-hidden bg-muted border-2 border-border">
